...
class MenuConfig( object ):
	def __init__( self ):
		...
		gladefile = os.path.join(self.path, 'MenuConfig.glade')
		...
		self.mainWindow.set_icon_from_file('/usr/lib/tuquito/tuquito-menu/tuquito-logo.svg')
		...
		self.gconf = EasyGConf('/apps/tuquito-menu/')
		self.gconfApplications = EasyGConf("/apps/tuquito-menu/plugins/applications/")
		self.gconfPlaces = EasyGConf( "/apps/tuquito-menu/plugins/places/" )
		self.gconfSystem = EasyGConf( "/apps/tuquito-menu/plugins/system-management/" )
	...
	def toggleRecent(self, widget):
		if self.showRecentPlugin.get_active():
			os.system("gconftool-2 --type list --list-type string --set /apps/tuquito-menu/plugins_list [newpane,places,system_management,newpane,applications,newpane,recent]")
		else:
			os.system("gconftool-2 --type list --list-type string --set /apps/tuquito-menu/plugins_list [newpane,places,system_management,newpane,applications]")

	def getRecentToggle(self):
		if (commands.getoutput("gconftool-2 --get /apps/tuquito-menu/plugins_list | grep recent | wc -l") == "0"):
			return False
		else:
			return True
	...
	def newPlace(self, newButton):
		...
		newPlaceDialog.set_icon_from_file("/usr/lib/tuquito/tuquito-menu/tuquito-logo.svg")
	...
	def editPlace(self, editButton):
		...
		editPlaceDialog.set_icon_from_file("/usr/lib/tuquito/tuquito-menu/tuquito-logo.svg")
