...
class pluginclass( object ):
	...
	def __init__( self, MenuWin, toggleButton ):
		...
		# Gconf stuff
		self.gconf = EasyGConf( "/apps/tuquito-menu/plugins/places/" )
	...
	def do_standard_places( self ):		
		...
		if ( self.showcomputer == True ):
			...
			self.MenuWin.setTooltip( Button1, _("Browse all local and remote disks and folders accessible from this computer") )
		...
		if ( self.showhomefolder == True ):
			...
			self.MenuWin.setTooltip( Button2, _("Open your personal folder") )
		...
		if ( self.shownetwork == True ):
			...
			self.MenuWin.setTooltip( Button3, _("Browse bookmarked and local network locations") )
		...
		if ( self.showdesktop == True ):
			...
			self.MenuWin.setTooltip( Button4, _("Browse items placed on the desktop") )
		...
		if ( self.showtrash == True ):
			...
			self.MenuWin.setTooltip( self.trashButton, _("Browse deleted files") )
