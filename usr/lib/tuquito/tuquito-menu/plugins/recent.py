...
class pluginclass:
	...
	def __init__(self, MenuWin, toggleButton):
		...
		self.gconf_dir = '/apps/tuquito-menu/plugins/recent'
		self.client = gconf.client_get_default()
		self.client.add_dir( '/apps/tuquito-menu/plugins/recent', gconf.CLIENT_PRELOAD_NONE )
		self.client.notify_add( '/apps/tuquito-menu/plugins/recent/height', self.RegenPlugin )
		self.client.notify_add( '/apps/tuquito-menu/plugins/recent/width', self.RegenPlugin )
		self.client.notify_add( '/apps/tuquito-menu/plugins/recent/num_recent_docs_to_show', self.RegenPlugin )
		self.client.notify_add( '/apps/tuquito-menu/plugins/recent/recent_font_size', self.RegenPlugin )
	...
	def GetGconfEntries( self ):
		self.gconf = EasyGConf( "/apps/tuquito-menu/plugins/recent/" )
