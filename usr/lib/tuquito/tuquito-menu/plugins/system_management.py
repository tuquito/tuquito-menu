...
class pluginclass( object ):
	...
	def __init__( self, MenuWin, toggleButton ):
		...
		# Gconf stuff
		self.gconf = EasyGConf( "/apps/tuquito-menu/plugins/system-management/" )
	...
	def do_standard_items(self):
		...
		if ( self.showTerminal == True ):
			...
			self.MenuWin.setTooltip( Button4, _("Use the command line") )
		...
		if ( self.showLockScreen == True ):
			...
			self.MenuWin.setTooltip( Button5, _("Requires password to unlock") )
		...
		if ( self.showLogout == True ):
			...
			self.MenuWin.setTooltip( Button6, _("Log out or switch user") )
		...
		if ( self.showQuit == True ):
			...
			self.MenuWin.setTooltip( Button7, _("Shutdown, restart, suspend or hibernate") )
